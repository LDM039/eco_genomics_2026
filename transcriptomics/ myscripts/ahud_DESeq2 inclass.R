...
hist(apply(countsTableRound,1,mean),xlim=c(0,1000), ylim=c(0,40000),breaks=10000)
...
#Now lets transform our data so that we can make a PCA plot
...
#Make heatmap to look for sample outliers
...
# Note any outliers 
#Maybe one from AH (Ocean acidification) F2 rep 2

#Make cluster tree to look for outlier samples
...
#Lets make this prettier and easier to interpret by seperating generations
...
png("./myresults/PCA_allGens.png", res=300, height=8, width=8, units="in")
